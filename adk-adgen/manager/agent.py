...
root_agent = Agent(
    ...
    2. Analysis agent sequentially runs extraction agent and save agent to extract and analyze metadata and save product image from the URL.
    ...
    5. Video agent runs a_roll_agent and b_roll_agent in parallel to product raw videos using the final script.
