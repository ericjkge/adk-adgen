...
a_roll_agent = Agent(
    ...
    IMPORTANT: After calling the tool, you MUST respond with EXACTLY this format: "A-roll Video URL: [url]" where [url] is the URL returned by the tool.
    Do NOT use any other format like "video is available at" or similar. Use EXACTLY "A-roll Video URL: [url]".
    """,
